...
int main(int argc, char *argv[]) {
    if (argc != 2 && argc != 3) {
        std::cout << "Usage: binpl [binary file]" << std::endl;
        return 1;
    }

    // Check for help option
    if (argc == 2 && (strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "--help") == 0)) {
        std::cout << "Usage: binpl [binary file] [-d or --decimalMode] [-h or --hexadecimal]" << std::endl;
        std::cout << "       -v or --version       Version information." << std::endl;
        std::cout << "       -h or --help          Usage information." << std::endl;
        std::cout << "       -d or --decimal       Interpret binary as decimal numbers." << std::endl;
        std::cout << "       -h or --hexadecimal   Interpret binary as hexadecimal numbers." << std::endl;
        std::cout << "       --author              Author information." << std::endl;
        return 0;
    }
...
void interpretBinary(const std::string &binaryCode, int decimalMode, int hexadecimalMode) {
    ...
    if (len % 8 != 0) {
        std::cerr << "Error: Invalid binary string length" << std::endl;
        exit(1);
    }
